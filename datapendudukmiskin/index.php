  ...
  <body>
    ...
    <script type="text/javascript">
      function initMap() {
        ...
        for (i = 0; i < location.length; i++) {
          ...
          */
          google.maps.event.addListener(marker,'click',(function(marker,i){
            return function(){
              infowindow.setContent('<h3>Kecamatan '+location[i][2]+'<h3>'+
                                    '<h4>Data Kependudukan</h4>'+
                                    '<p><b>Penduduk Miskin (KK) : '+location[i][3]+'<br>'+
                                    'Total Penduduk (KK) : '+location[i][4]+'<br>'+
                                    'Persentase : '+location[i][5]+'%'+'</b></p>'
                                    );
        ...
        var mapOpt = {
          zoom: 8,
          center: new google.maps.LatLng(-7.005375776465116, 110.43522680983412),
          mapTypeId: google.maps.MapTypeId.ROADMAP
        }
